...
//IfNote:you wanna to get a proper and wonderful # of electrons, 
//you must fit the nuclear # to what it would be. 
//And you need to make sure which orbital is valid 
//(To better your thoughts, you can assume that only these orbitals can hold unfixed electron. (Actually, this assumption is set for the simplified of the Fock Matrix calculations (to me). 
// BUT I don¡¯t know whether it is accepted while the invalid orbitals seem like to overlap the other orbitals to change the energy of electrons we focused. (Sad)
